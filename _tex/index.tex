...
\hypersetup{
  pdftitle={Test of Quarto Manuscript},
  pdfauthor={Author 1; Author 2},
  pdfkeywords={Subject 1, Subject 2},
  colorlinks=true,
  linkcolor={blue},
  filecolor={Maroon},
  citecolor={Blue},
...
\begin{document}
\title{Test of Quarto Manuscript}

\authors{Author 1\affil{1}, Author 2\affil{2}}
\affiliation{1}{Author 1 University, }\affiliation{2}{Author 2
Institute, }
\correspondingauthor{Author 1}{author1@email.com}
...
For the general audience: Earthquake data for the island of La Palma
from the September 2021 eruption is found \ldots{}
...
\textsubscript{Source:
\href{https://biniv.github.io/manuscript_template/index.qmd.html}{Article
Notebook}}
...
\textsubscript{Source:
\href{https://biniv.github.io/manuscript_template/notebooks/explore-earthquakes-preview.html\#cell-fig-spatial-plot}{Explore
Earthquakes}}
